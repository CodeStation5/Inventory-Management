...
class PartTest {
    ...
    void getInvHigh() {
        int invHigh = 100;
        partIn.setInv(invHigh);
        assertEquals(invHigh, partIn.getInv());
        partOut.setInv(invHigh);
        assertEquals(invHigh, partOut.getInv());
    }
    @Test
    void getInvLow() {
        int invLow = 1;
        partIn.setInv(invLow);
        assertEquals(invLow, partIn.getInv());
        partOut.setInv(invLow);
        assertEquals(invLow, partOut.getInv());
    }
}