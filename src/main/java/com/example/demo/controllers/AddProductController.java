...
public class AddProductController {
    ...
    // Connect main page to add products page
    ...
    public String showFormAddPart(Model theModel) {
        ...
        // Create an array list to save all the parts that can be made
    ...
    // Connect to page to delete a product
    ...
    // Connect to a page to remove parts
